...
-- -----------------------------------------------------------
-- Seed: Kasir (sesuai cashiers.txt & data default aplikasi)
-- -----------------------------------------------------------
INSERT INTO cashiers (id_kasir, nama_kasir, password, shift, is_active) VALUES
('K001', 'Ahmad Kasir', '123', 'Pagi',  FALSE),
('K002', 'Reva Kasir',  '123', 'Siang', FALSE),
('K003', 'Asep Kasir',  '123', 'Malam', FALSE),
('K004', 'Amel Kasir',  '123', 'Pagi',  FALSE)
...
ON DUPLICATE KEY UPDATE nama_pemesan = VALUES(nama_pemesan);
...
ON DUPLICATE KEY UPDATE biaya_layanan = VALUES(biaya_layanan);

-- -----------------------------------------------------------
-- Seed: Menu Ramen (12 item, M001 - M012)
-- -----------------------------------------------------------
INSERT INTO menu (id_menu, nama_menu, harga, kategori, tingkat_kepedasan, tekstur_mi, topping_tambahan, is_cold, detail_khusus) VALUES
-- Tori Ramen (Ayam) - Rp 38.000
('M001', 'Shio Tori Ramen',    38000, 'ramen', 0, 'Sedang', 'Chashu, Tamago, Nori', NULL, 'Chashu · Tamago · Nori'),
('M002', 'Shoyu Tori Ramen',   38000, 'ramen', 0, 'Sedang', 'Chashu, Tamago, Nori', NULL, 'Chashu · Tamago · Nori'),
('M003', 'Miso Tori Ramen',    38000, 'ramen', 0, 'Sedang', 'Chashu, Tamago, Nori', NULL, 'Chashu · Tamago · Nori'),
('M004', 'Paitan Tori Ramen',  38000, 'ramen', 0, 'Sedang', 'Chashu, Tamago, Nori', NULL, 'Chashu · Tamago · Nori'),
-- Beef Ramen - Rp 45.000
('M005', 'Shio Beef Ramen',    45000, 'ramen', 0, 'Sedang', 'Beef Slices, Tamago, Nori', NULL, 'Beef Slices · Tamago · Nori'),
('M006', 'Shoyu Beef Ramen',   45000, 'ramen', 0, 'Sedang', 'Beef Slices, Tamago, Nori', NULL, 'Beef Slices · Tamago · Nori'),
('M007', 'Miso Beef Ramen',    45000, 'ramen', 0, 'Sedang', 'Beef Slices, Tamago, Nori', NULL, 'Beef Slices · Tamago · Nori'),
('M008', 'Paitan Beef Ramen',  45000, 'ramen', 0, 'Sedang', 'Beef Slices, Tamago, Nori', NULL, 'Beef Slices · Tamago · Nori'),
-- Tempura Ramen - Rp 42.000
('M009', 'Shio Tempura Ramen',   42000, 'ramen', 0, 'Sedang', 'Tempura, Tamago, Nori', NULL, 'Tempura · Tamago · Nori'),
('M010', 'Shoyu Tempura Ramen',  42000, 'ramen', 0, 'Sedang', 'Tempura, Tamago, Nori', NULL, 'Tempura · Tamago · Nori'),
('M011', 'Miso Tempura Ramen',   42000, 'ramen', 0, 'Sedang', 'Tempura, Tamago, Nori', NULL, 'Tempura · Tamago · Nori'),
('M012', 'Paitan Tempura Ramen', 42000, 'ramen', 0, 'Sedang', 'Tempura, Tamago, Nori', NULL, 'Tempura · Tamago · Nori')
ON DUPLICATE KEY UPDATE
...
-- -----------------------------------------------------------
INSERT INTO menu (id_menu, nama_menu, harga, kategori, tingkat_kepedasan, tekstur_mi, topping_tambahan, is_cold, detail_khusus) VALUES
('M013', 'Es Matcha Latte', 22000, 'minuman', NULL, NULL, NULL, TRUE,  'Less sugar available'),
('M014', 'Es Teh Tarik',    15000, 'minuman', NULL, NULL, NULL, TRUE,  'Creamy blend'),
('M015', 'Gyoza (6 pcs)',   28000, 'snack',  NULL, NULL, NULL, FALSE, 'Pork Filling'),
('M016', 'Karaage',         25000, 'snack', NULL, NULL, NULL, FALSE, 'Chicken · Mayo sauce'),
('M017', 'Takoyaki (6)',    23000, 'snack', NULL, NULL, NULL, FALSE, 'Octopus · Bonito')
ON DUPLICATE KEY UPDATE
    nama_menu = VALUES(nama_menu),
    harga     = VALUES(harga);
...
--   menu             → Daftar menu restoran
--   customers        → Data pelanggan
--   layanan          → Tipe layanan (Dine In / Take Away / Delivery)
--   transactions     → Header transaksi
--   kustomisasi_pesanan → Kustomisasi ramen
--   invoice_items    → Detail item pesanan
